...
import 'customViews/CustomAppBar.dart';
import 'styles/CustomStyles.dart';

class ReceivedOrderView extends StatefulWidget {
  const ReceivedOrderView({Key? key}) : super(key: key);

  @override
  _ReceivedOrderViewState createState() => _ReceivedOrderViewState();
}

class _ReceivedOrderViewState extends State<ReceivedOrderView> {
    ...
    return  Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
              flex: 1,
              child:Text(details["custome_visit_date"]+" " +details["custome_visit_time"],
                  style:CustomStyles.smallTextStyle(context))
          )
        ],
      ),
